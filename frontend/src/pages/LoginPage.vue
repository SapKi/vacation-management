...
.lp-submit:hover:not(:disabled) { background: linear-gradient(135deg, #ffe600 0%, #fff176 100%); transform: translateY(-1px); }
...
.lp-link { color: #ffe600; text-decoration: none; font-weight: 600; }
.lp-link:hover { color: #fff176; }

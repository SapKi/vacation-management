    ...
    <form @submit.prevent="handleSubmit" novalidate>
      <div class="form-group">
        ...
        <input
          ...
          class="form-input" :class="{ error: errors.startDate }" :min="today"
        />
      ...
      <div class="form-group">
        ...
        <input
          id="endDate" v-model="form.endDate" type="date"
          class="form-input" :class="{ error: errors.endDate }" :min="form.startDate || today"
        />
      ...
      <div class="form-group">
        ...
        <textarea
          id="reason" v-model="form.reason" class="form-textarea"
          placeholder="e.g. Family trip, personal days..." rows="3"
        />
      </div>

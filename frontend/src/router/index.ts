...
const router = createRouter({
  ...
  routes: [
    ...
    { path: ROUTES.REQUESTER, component: RequesterPage, meta: { requiresAuth: true, role: UserRole.REQUESTER } },
    { path: ROUTES.VALIDATOR, component: ValidatorPage, meta: { requiresAuth: true, role: UserRole.VALIDATOR } },
  ],
});
